...
function about() {
    document.getElementById("footercontent").innerHTML = "<div style='animation-name: goUp; animation-duration: 1.5s;'><p>About Our Company:</p><p>DESIGN-ated is an e-commerce website primarily used for you to buy different clothing and designs that you want.</p><p>'Creativity is your only limit'</p></div>";
}
function review() {
